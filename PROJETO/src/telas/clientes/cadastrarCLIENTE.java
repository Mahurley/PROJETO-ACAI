...
public class cadastrarCLIENTE {
	...
	private void initialize() {
				...
				.addGroup(groupLayout.createParallelGroup(Alignment.LEADING).addGroup(groupLayout
						...
						.addGroup(groupLayout.createSequentialGroup().addGap(61)
								.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING, false)
										.addComponent(getLblRESPOSTA(), Alignment.LEADING, GroupLayout.DEFAULT_SIZE,
		...
		groupLayout.setVerticalGroup(groupLayout.createParallelGroup(Alignment.LEADING).addGroup(groupLayout
				...
				.addGap(6)
				.addGroup(groupLayout.createParallelGroup(Alignment.LEADING).addComponent(lblNewLabel_1_1_1)
